...
<div id="HowToUsePanel">
	<div id="UseSite">
    	<p align="center" >
                <h2  >نحــوه اسـتفاده</h2>
           شـما می تـوانیـد بـا سـاختـن یـک اکانـت بـدون پرداخـت هیـچ هزیــنه ای از تمـام امـکــانات سایــت استـفاده کنید <br/>
           در صــفحه ی پروفایــل ،  پروژه ی خـود را تـعریـف کنیــد <br/>
              و در صـفحـه ی پروفایــل پروژه آن را به بخــش های مجزا تقسیــم و به افراد گــروه محــول کنیــد<br/>
             و در همـان صفحـه روند پیــشـرفت پروژه توسط اعضـا را کنتـرل کنیــد ، و در صـورت نیـاز به آن ها پیام دهـیــد<br/>
              در پـروفایـل خـود ایـده هایی کـه در ذهن داریـد را ثبــت و نگهـداری کنیـد و <br/>
              به کمک تقـویمی که در صـفحـه ی پـروفایـل خود دارید مـی تـوانیـد علاوه بر تحت نظر گرفتـن مهلت تحویل پروژه ها ، یادآوری های شخصی خـود را نیـز به آن اضافه کنیـد<br/>
              پیشـنهاد می کنیـم که پس از ثبـت نام ، اطلاعـات خـود را برای کامل تر شدن پـروفایـل ، در قسمـت تنظیـمات کاربری در صـفحه ی شخصــی تکمیل کنید<br/>
              برای اینکه همیـشه پروژه هایتـان را تحت نظر داشـته باشید می تـوانید با همین اکانت در نرم افـزار موبایـل به اطلاعاتتان دسترسی داشـته باشــید<br/>         
            </p>
    </div>
</div>  <!-- end of HowToUse -->
<!-- ----------------------------------------------------AppPanel----------------------------------------------------------  -->
