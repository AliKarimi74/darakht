...
<body>
    ...
    <div class="detailsPop">
    	...
    	<div id="right">
            ...
            <br/>
            <br/>
          <!--  <div ><div id="degreeBD"><span id="degree">دلپــلم</span></div><span>مـدرک تـحصیـلی</span> </div>-->
            <!--<div > <input type="text" size="30%"/> <span>حوزه فعـالیـت </span> </div>-->
            ...
            <?php if (!empty($linkin_profile)) { ?><div > <div id="twitterBD"><a href="<?php echo $linkin_profile; ?>" target="_blank"><span id="twitter"><?php echo $linkin_profile; ?></span></a></div> <span>لینکـدین <img src="in.png"  height="20em" width="20em" /> </span> </div><?php } ?>
